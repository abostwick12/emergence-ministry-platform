...
| Align environment docs by assistant owner | Camp fallback and SAGE Phase 1B can use server-only `OPENAI_API_KEY`; Command Center shows SAGE unavailable when the key is missing | Continue separating Camp EMMA and SAGE data access |
